<script>
	import Math from '../lib/images/math.jpg';
	import './app.css';
</script>
...
<section class="min-w-screen min-h-screen relative">
	<img src={Math} alt="Math background" class="image" />
	<div class="w-full h-full absolute cover z-1" />
